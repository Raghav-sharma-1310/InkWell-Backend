...
```bash
ssh -i your-key.pem ubuntu@51.21.94.139.nip.io
```
...
OAUTH2_REDIRECT_URI=http://51.21.94.139.nip.io/oauth/success
MEDIA_PUBLIC_BASE_URL=http://51.21.94.139.nip.io/api/media/public/files
```
...
1. Open frontend: `http://51.21.94.139.nip.io`.
...
```bash
scp docker-compose.prod.yml ubuntu@51.21.94.139.nip.io:/opt/inkwell/
scp docker/mysql-init/* ubuntu@51.21.94.139.nip.io:/opt/inkwell/docker/mysql-init/
```
...
- `EC2_HOST`: `ubuntu@51.21.94.139.nip.io`
...
And frontend API calls go to the public gateway:

```text
http://51.21.94.139.nip.io:8080/api/...
```
...
```bash
curl -I http://51.21.94.139.nip.io
curl http://51.21.94.139.nip.io/health
```
