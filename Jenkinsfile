...
pipeline {
  ...
  parameters {
    string(name: 'EC2_HOST', defaultValue: 'ubuntu@51.21.94.139.nip.io', description: 'SSH target for the EC2 deployment host')
    string(name: 'EC2_APP_DIR', defaultValue: '/opt/inkwell', description: 'Directory on EC2 containing .env and compose files')
    string(name: 'VITE_API_BASE_URL', defaultValue: 'http://51.21.94.139.nip.io:8080', description: 'Frontend API base URL baked into the Vite build')
  }
